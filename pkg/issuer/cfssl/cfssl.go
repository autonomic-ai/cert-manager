...
func NewCFSSL(ctx *controller.Context, issuer cmapi.GenericIssuer) (issuer.Interface, error) {
...
func cfsslClient(issuer cmapi.GenericIssuer, secretsLister corelisters.SecretLister, resourceNamespace string) (cfsslclient.Remote, error) {
