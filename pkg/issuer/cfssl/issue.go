...
func (c *CFSSL) Issue(ctx context.Context, crt *cmapi.Certificate) (*issuer.IssueResponse, error) {
...
func buildInfoRequest(conf *cmapi.CFSSLCertificateConfig) ([]byte, error) {
...
func buildSignRequest(csr []byte, conf *cmapi.CFSSLCertificateConfig) ([]byte, error) {
